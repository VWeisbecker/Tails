...
#Marsupials
      ...
      ##but is there any impact of body weight once head/body length is accounted for?
      MarsTBW=find.best.model(Tl_mm~Bl_mm*Wt_g,marsTree,mars);MarsTW$AIC_Weights
      #Checking appropriate distribution of model residuals
      qqnorm (MarsTBW$Models$Brownian)
      anova(MarsTBW$Models$Brownian)
      ...
      anova(MarsTBWNoInter$Models$Brownian)
...
#Rodents
  ...
  ##With Rattus
      ...
      anova(rodTBWNoInter$Models$Brownian_GrafScale)
      ...
      #Checking appropriate distribution of model residuals
      qqnorm (MurTBW$Models$Brownian)
      anova(MurTBW$Models$Brownian)
      ...
      anova(MurTBWNoInter$Models$Brownian_GrafScale)
