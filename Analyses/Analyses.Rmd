...
#collate dataset; add a column for averaged values
...
##average the columns, add to mars_sexes; averaging requires un-loggin and re-logging
  ...
  mars_sexes<-cbind(mars_sexes,mars_sex_Tl_av,mars_sex_Bl_av )


#preparing for testing for sig differences in slope/intercept between male and female datasets; includes putting males/females under each other, turnign into a data frame for column names

Males<-cbind(mars_sexes$Tl_M,mars_sexes$Bl_M,rep(1,length(mars_sexes$Tl_M)))
Females<-cbind(mars_sexes$Tl_F,mars_sexes$Bl_F,rep(2,length(mars_sexes$Tl_F)))
Averages<-cbind(mars_sexes$mars_sex_Tl_av, mars_sexes$mars_sex_Bl_av, rep(3,length(mars_sexes$Tl_F)))
