...
#First, some basic data on the quality of the raw data
...
DataQuality=as.data.frame(rbind(sapply(marsraw[,2:28], function(x) sum(!is.na(x))),sapply(rodraw[,2:28], function(x) sum(!is.na(x)))))
