...
hist(data$Bl_mm, main="Frequency distribution of log Body length (mm)")
hist(data$Tl_mm, main="Frequency distribution of log Tail length (mm)")
hist(data$Wt_g, main="Frequency distribution of log Body mass (g)")
...
ArbPentline_Bl_formula <- gls(Tl_mm~Bl_mm, correlation=corBrownian (1,phy=ArbPentTree), data=ArbPent)
ArbPentLine<-pgls.abline.function (ArbPentline_Bl_formula$coefficients[1],ArbPentline_Bl_formula$coefficients[2], 1.8,2.8)

paste("lines(x=c(" , ArbPentLine[[1]][1], "," , ArbPentLine[[1]][2],")",",y=c(", ArbPentLine[[1]][3],",", ArbPentLine[[1]][4] , "))", sep="" )

pgls.abline.function <- function (model_intercept, model_slope, value1, value2){
 ...
 return(paste("x=c(" ,line_coords[[1]][1],line_coords[[1]][2]),")","y=c(",line_coords[[1]][3],line_coords[[1]][4]), ")" )
