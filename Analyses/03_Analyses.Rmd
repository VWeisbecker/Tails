...
# Within species, is there a relatively wider range of weights (i.e. is the minimum a smaller percentage of the maximum) than there is of body length and tail length? Bod mass ranges are substantially greater than tail and body length ranges, hinting at substantial within-species independence of tail/vertebral length compared to weight.
...
#Addressing the question if phylogenetic signal of tail and body length is higher than body weight because
...
#Also, weight should have greater disparity than body lenght and tail length:
