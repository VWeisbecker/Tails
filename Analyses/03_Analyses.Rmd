...
#TestInteractions seems odd - below is the problem
...
#in a non-phylogenetically corrected space, we can use the phia package to test for interactions, but quite frankly, these do not make sense based on the plot - the green group ("saltatorial") should have significant interactions with them all but doesn't, whereas some others are clearly 
