...
# Aside from the association between body length and tail length,does locomotor mode play a role? Note: sing the smaller, m/f specific datasets is not possible with interactions, so if interactions are found it seems inappropriate to run them
...
#Arboreal and prehensile species have different slopes to terrestrial, but not scansorial or pentapedal species. Ecologically this makes sense, so conducting a follow-up analysis separating arboreal and prehensile from the remainder.
