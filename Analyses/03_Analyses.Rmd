...
plot(data_ranges_Bl$Tl_mm~data_ranges_Bl$Bl_mm, col=colsLoco[data$Locomotor_use], pch = pchs[data$Order], xlab="log Body length (mm)", ylab="log Tail length" , xlim=c(1.5,3.6), ylim=c(1.5,3.3) ); 
DrawEllipse(x=data_ranges_Bl$Bl_mm, y=data_ranges_Bl$Tl_mm, radius.x = (data_ranges$Bl_max - data_ranges$Bl_min), radius.y = (data_ranges$Tl_max - data_ranges$Tl_min), col=alpha (colsLoco[data$Locomotor_use] , 0.05), border=colsLoco[data$Locomotor_use]);
...
#Tail vs body weight:
plot(data_ranges_Wt$Tl_mm~data_ranges_Wt$Wt_g, col=colsLoco[data$Locomotor_use], pch = pchs[data$Order], xlab="log Weigth (g)", ylab="log Tail length" , xlim=c(0.5,5), ylim=c(1,3.3), asp=1 ); 
DrawEllipse(x=data_ranges_Wt$Wt_g, y=data_ranges_Wt$Tl_mm, radius.x = (data_ranges$Bl_max - data_ranges$Bl_min), radius.y = (data_ranges$Tl_max - data_ranges$Tl_min), col=alpha (colsLoco[data$Locomotor_use] , 0.05), border=colsLoco[data$Locomotor_use]);
