...
plot(data$Tl_mm~data$Bl_mm, col=colsLoco[data$Locomotor_use], pch = pchs[data$Order], xlab="log Body length (mm)", ylab="log Tail length",asp=1 ); 
...
plot(data$Tl_mm~data$Wt_g, col=colsLoco[data$Locomotor_use], pch = pchs[data$Order], xlab="log Weight (g)", ylab="log Tail length" , asp=1);
legend("bottomright",inset=0.25,levels(data$Order) , pch=pchs,  cex=cexes,x.intersp = xinter, y.intersp = yInter, text.width = textwidth, bty="n" );
...
legend("bottomright",inset=0.13,levels(data$Order) , pch=pchs,  cex=cexes,x.intersp = xinter, y.intersp = yInter+0.3, text.width = textwidth, bty="n" );
