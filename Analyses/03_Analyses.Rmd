...
ArbPentline_Bl <- gls(Tl_mm~Bl_mm, correlation=corBrownian (1,phy=ArbPentTree), data=ArbPent)
...
ArbPentLine<-pgls.abline.function (ArbPentline_Bl$coefficients[1],ArbPentline_Bl$coefficients[2], 2,2.8)
