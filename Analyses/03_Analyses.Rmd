...
phylosig(brlentree, data$Tl_mm, method = "K", test=TRUE, nsim=1000)
phylosig(brlentree, data$Bl_mm, method="K", test=FALSE, nsim=1000)
phylosig(brlentree, data$Wt_g, method="K", test=FALSE, nsim=1000)
...
#is there a difference in tail/body length relationships between the sexes? This is only possible in a non phylogenetic context
