...
arrows(x0=1,x1=2, y0=3, y1=3, length = 0.1, angle = 90, code=3, lwd=lwd, ); 
  text(x=1.5, y=3.2, labels="p=0.67"); 
  text(x=1, y=0.9, labels="mean=1.44");
  text(x=2, y=0.9, labels="mean=1.44");
  text(x=3, y=0.9, labels="mean=2.64")
...
arrows(x0=1,x1=2, y0=3.5, y1=3.5, length = 0.1, angle = 90, code=3, lwd=lwd, ); text(x=1.5, y=3.7, labels="p=0.56")
  text(x=1, y=0.9, labels="mean=1.43");
  text(x=2, y=0.9, labels="mean=1.43");
  text(x=3, y=0.9, labels="mean=2.55")
...
```{r}
  ...
  ##Tail vs body weight: suggestive of geometric similarity at 0.32
