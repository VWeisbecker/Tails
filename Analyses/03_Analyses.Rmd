...
lines(x=c(1.7,3.1),y=c(1.64141993621454,2.66363472373482), col=colsLoco[5], lwd=2)
...
lines(x=c(0.6,4.5),y=c(1.69836821022779,2.56642013396235), col=colsLoco[5], lwd=2)
