...
# Phylogenetic testing - do arboreal/pentapedal species have significantly lower ranges than others?
...
#determine the regression line coefficients from apgls analyses for each locomotor group, with separate lines for the locomotor modes. 
