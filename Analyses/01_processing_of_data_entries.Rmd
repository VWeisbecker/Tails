...
#Now create and fill columns with overall range averages; but where m/f ranges area available, these will be overwritten in the next step as these are better data
