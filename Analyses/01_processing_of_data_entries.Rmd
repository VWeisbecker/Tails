...
#now re-process data_processed to fill NAs in the main values, first by av eraging male/female values, second (if sex averages are not available) by averaging sex-less min/max values. This overwrites the first pass summary version of data_processed with the second pass summary version
